...
- Copy and clone this link locally `git@github.com:Alfred-KInyua/hello-rails-react.git`.
- Go to the repository folder in your command prompt `hello-rails-react`.
