...
class GreetingsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create greeting" do
    assert_difference("Greeting.count") do
      post greetings_url, params: { greeting: { hello_messages: @greeting.hello_messages } }, as: :json
    end
  ...
  test "should update greeting" do
    patch greeting_url(@greeting), params: { greeting: { hello_messages: @greeting.hello_messages } }, as: :json
    assert_response :success
  end
